<!-- Payment page for Beach View Deluxe Room -->
<?php
...
<title>Beach View Deluxe Room</title>
...
<div class="payment">
  <div class="col-75">
		...
		<div class="payment">
		  <div class="col-50"><br>
			...
			<select id="room-select" name="roomType" onchange="updateTotal()">
			  <option value="" disabled selected>-- Please select --</option>
			  <option value="350">Single bed Without Landa travel package - RM350</option>
			  <option value="550">Single bed With Landa travel package - RM550</option>
			  <option value="650">King-sized bed Without Landa travel package - RM650</option>
			  <option value="750">King-sized bed With Landa travel package - RM750</option>
			</select>
	...
	<input type="submit" name="book" value="Book Now" class="btn"><br><br><!-- submit button -->
	  </form>
	</div>
	</div>
	</div>
	<div id="order" class="col-25">
		  <div class="paycontainer">
			<h4>Beach View Deluxe Room<span class="price" style="color:black"></span></h4><br>
			<div class="image">
			<img src="Pictures/Room3.jpg"></div><br><br>
			...
			<p style="font-size: 2rem;">Room Type: <b><span id="room-type"></span></b></p><br><br>
			 <div class="price-container">
			  ...
			  <label>Total price:<span id="total-price"></span></label>
			</div>
		  </div>
		</div>
	  </div>
...
switch (value) {
  case 350:
	roomType.textContent = "Single bed room without Landa Travel Package";
	break;
  case 550:
	roomType.textContent = "Single bed room with Landa Travel Package";
	break;
  case 650:
	roomType.textContent = "King-sized bed room without Landa Travel Package";
	break;
  case 750:
	roomType.textContent = "King-sized bed room with Landa Travel Package";
	break;
  default:
