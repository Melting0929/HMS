<!-- Payment page for City View Deluxe Room -->
<?php
...
<title>City View Deluxe Room</title>
...
<div class="payment">
  <div class="col-75">
		...
		<div class="payment">
		  <div class="col-50"><br>
			...
			<!-- include the updateTotal() function in the script -->
			  <option value="" disabled selected>-- Please select --</option>
			  <option value="350">Single bed Without Kanda travel package - RM350</option>
			  <option value="550">Single bed With Kanda travel package - RM550</option>
			  <option value="650">King-sized bed Without Kanda travel package - RM650</option>
			  <option value="750">King-sized bed With Kanda travel package - RM750</option>
			</select>
	...
	<div id="order" class="col-25">
		  <div class="paycontainer">
			<h4>City View Deluxe Room<span class="price" style="color:black"></span>
			  </h4><br>
			<div class="image">
			<img src="Pictures/gallery5.jpg"></div><br><br>
...
switch (value) {
  case 350:
	roomType.textContent = "Single bed room without Kanda Travel Package";
	break;
  case 550:
	roomType.textContent = "Single bed room with Kanda Travel Package";
	break;
  case 650:
	roomType.textContent = "King-sized bed room without Kanda Travel Package";
	break;
  case 750:
	roomType.textContent = "King-sized bed room with Kanda Travel Package";
	break;
  default:
